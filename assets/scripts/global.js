...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  if (themeid == 'light') {
    themeEle.href = '../styles/theme/solid/light.css'
  }
  if (themeid == 'm') {
  ...
  if (themeid == 'midnight') {
    themeEle.href = '../styles/theme/solid/midnight.css'
  }
  if (themeid == 'black-red') {
    themeEle.href = '../styles/theme/gradient/black-red.css'
  }
  if (themeid == 'black-blue') {
    themeEle.href = '../styles/theme/gradient/black-blue.css'
  }
  if (themeid == 'black-green') {
    themeEle.href = '../styles/theme/gradient/black-green.css'
  }
  if (themeid == 'red') {
    themeEle.href = '../styles/theme/gradient/red.css'
  }
  if (themeid == 'purple') {
    themeEle.href = '../styles/theme/gradient/purple.css'
  }
  if (themeid == 'black-orange') {
    themeEle.href = '../styles/theme/gradient/black-orange.css'
  }
  if (themeid == 'ocean-blue') {
    themeEle.href = '../styles/theme/solid/ocean-blue.css'
  }
  if (themeid == 'black-purple') {
    themeEle.href = '../styles/theme/gradient/black-purple.css'
  }
  if (themeid == 'black-coral') {
    themeEle.href = '../styles/theme/gradient/black-coral.css'
  }
  if (themeid == 'black-ruby') {
    themeEle.href = '../styles/theme/gradient/black-ruby.css'
  }
  if (themeid == 'black-yellow') {
    themeEle.href = '../styles/theme/gradient/black-yellow.css'
  }
  if (themeid == 'black-pink') {
    themeEle.href = '../styles/theme/gradient/black-pink.css'
  }
  if (themeid == 'black-white') {
    themeEle.href = '../styles/theme/gradient/black-white.css'
  }
  if (themeid == 'dark-purple') {
    themeEle.href = '../styles/theme/gradient/dark-purple.css'
  }
  if (themeid == 'sunset') {
    themeEle.href = '../styles/theme/gradient/sunset.css'
  }
  if (themeid == 'indigo') {
    themeEle.href = '../styles/theme/gradient/indigo.css'
  }
  if (themeid == 'fire-ice') {
    themeEle.href = '../styles/theme/gradient/fire-ice.css'
  }
  if (themeid == 'purple-blue') {
    themeEle.href = '../styles/theme/gradient/purple-blue.css'
  }
  if (themeid == 'catppuccinMocha') {
    themeEle.href = '../styles/theme/catppuccin/mocha.css'
  }
  if (themeid == 'catppuccinMacchiato') {
    themeEle.href = '../styles/theme/catppuccin/macchiato.css'
  }
  if (themeid == 'catppuccinFrappe') {
    themeEle.href = '../styles/theme/catppuccin/frappe.css'
  }
  if (themeid == 'catppuccinLatte') {
    themeEle.href = '../styles/theme/catppuccin/latte.css'
  }
